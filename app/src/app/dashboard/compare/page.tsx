...
export const metadata: Metadata = {
  title: "Compare Assets | Dashboard | Scouter",
  description:
    "Direct side-by-side comparison of PreStocks tokenised pre-IPO assets inside the Scouter Dashboard.",
};
        ...
        <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-4">
          <div>
            ...
            <p className="text-xs sm:text-sm text-on-surface-variant max-w-2xl mt-1 leading-relaxed font-light">
              Conduct objective side-by-side research on tokenised pre-IPO assets. Compare secondary token prices, implied valuations, and benchmark mark variance.
            </p>
          </div>
      ...
      {error ? (
        <div className="p-12 rounded-2xl bg-surface-container-low border border-error/30 text-center space-y-4 max-w-lg mx-auto my-12">
          ...
          <p className="text-sm text-on-surface-variant leading-relaxed font-light">
            The PreStocks live data feed could not be reached.
          </p>
        ...
        <div className="p-12 text-center text-on-surface-variant bg-surface-container-low/40 rounded-2xl border border-dashed border-outline-variant/30 font-light">
