      ...
      <div className="flex justify-between items-center h-16 px-4 md:px-6 lg:px-8 max-w-7xl mx-auto w-full">
        ...
        <div className="flex items-center gap-8">
          <Link href="/discover" className="flex items-center gap-2.5 group">
            <div className="w-8 h-8 rounded-lg bg-surface-container-high border border-outline-variant/40 flex items-center justify-center text-on-surface-variant group-hover:border-outline/70 group-hover:text-on-surface transition-colors">
            ...
            <div className="flex flex-col">
              ...
              <span className="text-[9px] font-label uppercase tracking-widest text-accent/70 -mt-1">
                PreStocks Terminal
              </span>
            </div>
          </Link>
        ...
        <div className="flex items-center gap-3">
          ...
          <a
            ...
            className="hidden sm:inline-flex items-center gap-1 text-xs text-on-surface-variant hover:text-on-surface transition-colors font-label px-2.5 py-1"
          >
